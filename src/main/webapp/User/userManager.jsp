            ...
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td><%=user.getIdUser()%></td>
		 			    ...
		 			    <td><a  href="/User/redirectUpdate?idUser=<%=user.getIdUser() %>"><i class="fa fa-edit"></i></a></td> 
		 				<td><a  href="/User/delete?idUser=<%=user.getIdUser() %>"> <i class="fa fa-trash-o"></i></a></td>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right" onclick="window.location.href='/User/insertUser.jsp'"><i class="fa fa-plus"></i>Insert User</button>
                </div>
