          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="/User/creaUser" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="reg_username">User name <span class="required">*</span></label>
                      <input type="text" class="form-control " name="username" id="username" placeholder="inserisci username" value="" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="radio">
                        ...
                        <label >User type <span class="required">*</span></label>
                         <label> <input type="radio" name="usertype" id="optionsRadios1" value="ADMIN" >
                         ADMIN</label>

                        <label>
                          <input type="radio" name="usertype" id="optionsRadios2" value="USER">
                      USER
                      </label>
                      </div>
