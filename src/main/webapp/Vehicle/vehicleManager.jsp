          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="/Home/userManagement/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="/Vehicle/vehicleManagement/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                ...
                <a href="/Sensor/sensorManagement/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table class="table table-hover">
                    <tr><th>VehicleId</th><th>NameVehicle</th><th>TypeVehicle</th><th>SpeedVehicle</th><th>WeightVehicle</th><th>LongVehicle</th><th>LatVehicle</th><th colspan=2>Option</th></tr>
		 			...
		 			<tr>
		 			    ...
		 			    <td><a  href="/Vehicle/redirectUpdate?idVehicle=<%=vehicle.getIdVehicle() %>"><i class="fa fa-edit"></i></a></td> 
		 				<td><a  href="/Vehicle/delete?idVehicle=<%=vehicle.getIdVehicle() %>"> <i class="fa fa-trash-o"></i></a></td>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right" onclick="window.location.href='/Vehicle/insertVehicle.jsp'"><i class="fa fa-plus"></i>Insert User</button>
                </div>
