            ...
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table class="table table-hover">
                    <tr><th>SensorId</th><th>LongSensor</th><th>LatSensor</th><th>SensorType</th><th colspan=2>Option</th></tr>
		 			...
		 			<tr>
		 			    ...
		 			    <td><a  href="/Sensor/redirectUpdate?idSensor=<%=sensor.getIdSensor() %>"><i class="fa fa-edit"></i></a></td> 
		 				<td><a  href="/Sensor/delete?idSensor=<%=sensor.getIdSensor() %>"> <i class="fa fa-trash-o"></i></a></td>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right" onclick="window.location.href='/Sensor/insertSensor.jsp'"><i class="fa fa-plus"></i>Insert User</button>
                </div>
