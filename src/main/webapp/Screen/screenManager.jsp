...
<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    ...
    <![endif]-->
	<%
	List<ScreenDTO> AllScreen = (List<ScreenDTO>) request.getAttribute("allScreenDTO");
	 %>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Of Screens</h3>
                  <div class="box-tools">
                    <div class="input-group">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr><th>ScreenId</th><th>Output</th><th colspan=2>Option</th></tr>
						<%
							for(ScreenDTO screen:AllScreen){
						 %>
		 			<tr>
		 				<td><%=screen.getIdScreen()%></td>
		 				<td><%=screen.getOutput()%></td>
		 			    <td><a  href="/Screen/redirectUpdate?idScreen=<%=screen.getIdScreen() %>"><i class="fa fa-edit"></i></a></td> 
		 				<td><a  href="/Screen/delete?idScreen=<%=screen.getIdScreen() %>"><i class="fa fa-trash-o"></i></a></td>
                ...
                <div class="box-footer clearfix no-border">
                  <button class="btn btn-default pull-right" onclick="window.location.href='/Screen/insertScreen.jsp'"><i class="fa fa-plus"></i>Insert User</button>
                </div>
