...
public class HomeAdminView extends AbstractView {
    ...
    public void showResults(Request request) {
    	if(request!=null) {
    	System.out.println("\n Benvenuto in  PROJECT "+request.get("username").toString() + "\n");
    	}
    }
    ...
    public void showOptions() {
        ...
        System.out.println("[U]tenti [Sc]reens [S]ensor [E]sci");
    ...
    public void submit() {    
        ...
        case "u":
        	...
        	break;
        case "sc":
        	this.request.put("mode", "ScreenLIST");
        	MainDispatcher.getInstance().callAction("Screen", "doControl", request);
        	break;
        case "s":
        	this.request.put("mode", "SENSORLIST");
