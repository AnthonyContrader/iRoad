...
public class SensorService {
	...
	public SensorDTO getByIdSensorAndSensorTyper(Integer idSensor, String sensorType) {

		final Sensor sensor = sensorRepository.findSensorByIdSensorAndSensorType(idSensor, sensorType);
	...
	public List<SensorDTO> findSensorDTOByIdSensor(Integer idSensor) {
		
		final List<Sensor> list = sensorRepository.findAllByIdSensor(idSensor);
